  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-center">
        <h1 className=" text-xl font-semibold font-sans text-navyblue">
          Features
        </h1>
      </div>
      <div className="grid md:grid-cols-3 gap-4 select-none">
        ...
        <div className="rounded-2xl bg-gradient-to-tr from-[#10B387]/40 to-babyblue w-full  p-5 md:p-10 text-navyblue h-100">
          <div className="space-y-4">
