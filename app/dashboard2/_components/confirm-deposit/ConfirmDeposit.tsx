...
import ConfirmDepositForm from "./ConfirmDepositForm";
import { useEffect, useState } from "react";
import ConfirmDetails from "@/components/dashboard/deposit/ConfirmDetails";
...
export default function ConfirmDeposit() {
  ...
  const checkMethodSetPrice = (method: string | "") => {
    switch (method) {
      case "usdt":
        setWalletAddress("TPbtv4cPYQQLKdA7MUvRaz3GErpWeG65iV");
        break;
      case "bitcoin":
        setWalletAddress("bc1q6mc3qtr2mgdy6ykrlr0sprdgqar92n3r83ehja");
        break;
      case "ethereum":
